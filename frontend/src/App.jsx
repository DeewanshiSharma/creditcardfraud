        ...
        <Route
          ...
          element={
            <ProtectedRoute isLoggedIn={isLoggedIn}>
              {/* Everything inside here only renders if logged in */}
                  ...
                  <div style={{ flex: 1, display: 'flex', justifyContent: 'center', gap: '4px' }}>
                    {[
                      ...
                      <NavLink key={to} to={to} style={({ isActive }) => ({
                        ...
                        padding: '6px 18px',
                        borderRadius: '8px',
                        background: isActive && to !== '/login' ? 'rgba(99,102,241,0.25)' : 'transparent',
                        border: isActive && to !== '/login' ? '1px solid rgba(99,102,241,0.5)' : '1px solid transparent',
                        textDecoration: 'none',
                        fontWeight: 600,
                        fontSize: '0.9rem',
                        transition: 'all 0.2s',
